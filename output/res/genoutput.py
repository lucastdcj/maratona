...
# used to indicate processing errors
return_code = 0
...
if __name__ == "__main__":
    ...
    fout = open("output/logs/note.tex", "w")
    append_file("output/res/header.tex", fout)

    directories = ["grafos", "pd", "geometricos", "numericos", "strings", "miscelanea"]
    ...
    for dir in directories:
        ...
        for file in os.listdir(dir):
            if file[-3:] == "cpp" or file[-1:] == "c" or file[-4:] == 'java':
